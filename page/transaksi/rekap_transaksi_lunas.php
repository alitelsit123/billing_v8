...
<body onload="window.print()">
    ...
    <table width="100%">
        <tr>
            <td width="0">&nbsp;</td>
            <td colspan="6">
                <div align="center"><strong>Data Tagihan Sudah Lunas <br> Bulan <?php echo  $bulan ?> Tahun <?php echo  $tahun ?> </strong></div>
            </td>
        </tr>
    ...
    <table class="tabel" border="1" width="100%">
        ...
        <tbody>
            ...
            WHERE tb_tagihan.bulan_tahun='$bulantahun' AND tb_tagihan.status_bayar = 1
